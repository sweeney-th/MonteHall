...
class MontyHall(object):
    ...
    def __init__(self):
        ...
        # convenient way to reffer to all the doors - could also use a dict
    ...
    """ runs desired number of instances of a game, returns array of results """        
...
switchResults = MontyHall.runSimulations(
    doorToGuess = "door1", numberOfGames = 5000, switchDoors = True
)
nonSwitchResults = MontyHall.runSimulations(
